...
static_assert(g_Inputs[337] == "~INPUT_MAP_POI~", "~Invalid inputs array");

const char* Inputs::GetControlString(eControl control) {
    if (control < 0 || control > 377) {
        return "error";
    }
    return g_Inputs[control];
}
